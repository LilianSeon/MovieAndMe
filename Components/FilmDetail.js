...
import { StyleSheet, Share, View, Text, ActivityIndicator, Image, TouchableOpacity } from 'react-native'
...
class FilmDetail extends React.Component {
  ...
  _shareFilm(){
    ...
    Share.share({ title: film.title, message: 'Titre : '+ film.title+'. '+ film.overview })
  }
